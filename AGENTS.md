...
2. The task-specific document under `hackathon/docs/` when the task is part of the hackathon extension:
   - Frontend: `hackathon/docs/frontend-plan.md`, `hackathon/docs/frontend-progress.md`, and `hackathon/docs/frontend-spec.md`
   - Backend: `hackathon/docs/backend-plan.md`, `hackathon/docs/backend-progress.md`, and `hackathon/docs/backend-spec.md`
...
- Follow `hackathon/docs/backend-plan.md`, `hackathon/docs/backend-progress.md`, and `hackathon/docs/backend-spec.md`.
